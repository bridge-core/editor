...
import { CreateProjectWindow } from '@/components/Project/CreateProject/CreateProject'
...
import { ProjectChooserWindow } from '@/components/Project/ProjectChooser/ProjectChooser'
